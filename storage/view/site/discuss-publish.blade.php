...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/static/editor-md/examples/css/style.css" />
...
<body>
        ...
        <div id="layout">
            <header>
                <div class="form-group">
                    <input type="text" class="form-control" style = "font-size: 24px; font-weight: 500;" id="recipient-name" placeholder="输入文章标题..." required>
                </div>
            </header>
            ...
            <div style="text-align: center">
                ...
                <button type="button" class="btn btn-outline-primary" id="publishBtn"
                        style="color: rgb(119, 84, 223)">发布文章</button>
            </div>
    ...
    <script src="/static/js/discuss-publish.js"></script>
